...
builder = StructureBuilder(2.0, 1.0, 3, 2, Material(1, 1.0), connectivity_ratio=Inf)
...
vol = 1.0
optimizer = Optimizer(compliance, max_iters=10000, volume_max=vol, filter_tol=0.0)
